...
namespace BethanysPieShopHRM.UI.Services {
    public class ExpensesApprovalService : IExpensesApprovalService {
        private IEmployeeDataService _employeeDataService;

        public ExpensesApprovalService(IEmployeeDataService employeeDataService) {
            _employeeDataService = employeeDataService;
        }
        public async Task<ExpenseStatus> GetApprovalExpense(Expense expense) {
